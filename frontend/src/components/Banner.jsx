...
const Banner = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-indigo-100 min-h-[90vh] flex items-center">

      <div className="absolute -top-40 -left-40 w-80 h-80 bg-indigo-200 rounded-full opacity-20 rotate-45"></div>
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-indigo-200 rounded-full opacity-20 rotate-12"></div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-8">
          <h1 className="text-5xl md:text-5xl lg:text-6xl font-extrabold text-gray-800">
            Crack the Code,<br />
            <span className="text-indigo-600">Ace the Interview With AlgoVik</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-700 max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-8 py-4 bg-white border-2 border-indigo-600 text-indigo-600 font-semibold rounded-full shadow-md hover:bg-indigo-50 transition"
            >
        ...
        <div className="hidden lg:flex justify-center">
          <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border border-gray-100 transform hover:scale-[1.02] transition-transform duration-300">
